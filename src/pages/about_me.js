...
export default function AboutMe(props) {
  ...
  return (
    <Layout>
      <SEO url={props.location.href} description="Meet the author of the travel blog, Where to Next, Doc? and find out more about the story behind her blog. " image={props.location.origin + props.data.imageSharp.fluid.src} title={"About Me"} type="article" date={new Date().toISOString()} category="About Me"/>
