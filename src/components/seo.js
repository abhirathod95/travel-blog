...
export default class SEO extends React.Component {
    ...
    render() {
        ...
        if (this.seo.type === "article") {
            metadata.push(
                <meta key="15" property="article:published_time" content={this.props.date}/>,
                <meta key="16" property="article:author" content="https://wheretonextdoc.com/about_me"/>,
                <meta key="17" property="article:section" content={this.props.category}/>,
