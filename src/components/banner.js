  ...
  render() {
    return (
      <Container
        fluid
        className="banner"
        style={{ minHeight: this.props.height, minWidth: this.props.width }}
      >
        <GatsbyImage
        ...
        />
        <h1
          className={this.props.showBottomText ? 'd-block display-1' : 'd-none'}
          style={{ position: 'absolute', bottom: '0', marginBottom: '-3rem' }}
        >
          {this.props.item.heading.toUpperCase()}
        </h1>
        <div className={this.props.showTextBox ? 'text-box' : 'd-none'}>
          <Row>
            ...
            <Col className="text-center">{this.props.item.subHeading}</Col>
            <Col>
              <hr />
            </Col>
          </Row>
          <Row>
            <Col className="text-center">
              <h1 className="text-center display-4 custom-raleway">
