...
export default function post() {
  return (
    ...
    <Container fluid className="blog-post">
      <Row>
        <Banner showBottomText showTextBox={false} width="100%" height="50vh" item={{'src':Chichen_Itza_0, 'subHeading':'Better Ways To','heading':'Travel Smarter', 'buttonText':'Read More', 'link':'/'}}/>
      </Row>
      <Row>
      ...
      <Row>
        <Col xs="6">
			...
			<img src={Chichen_Itza_1} style={{width:"100%"}}></img>
	  ...
	  <Row> 
        <Col xs="12">
          <img src={Chichen_Itza_2} style={{width:"100%"}}></img>
        </Col>
      </Row>
	  <Row>
		<Col xs="6">
	  ...
	  <Row> 
        <Col xs="4">
          <img src={Chichen_Itza_3} style={{width:"100%"}}></img>
        </Col>
        <Col xs="4">
          <img src={Chichen_Itza_4} style={{width:"100%"}}></img>
        </Col>
      </Row>
      <Row> 
        <Col xs="8">
          <img src={Chichen_Itza_5} style={{width:"100%"}}></img>
        </Col>
      </Row>
      <Row> 
        <Col xs="8">
          <img src={Chichen_Itza_6} style={{width:"100%"}}></img>
        </Col>
      </Row>
	  <Row>
		<Col xs="6">
	  ...
	  <Row>
	    ...
	    <Row> 
        <Col xs="12">
          <img src={Chichen_Itza_7} style={{width:"100%"}}></img>
        </Col>
      </Row>
	  <Row>
		<Col xs="6">
            ...
            <img src={Chichen_Itza_8} style={{width:"100%"}}></img>
